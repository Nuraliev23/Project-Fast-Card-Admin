...
const Orders = () => {
  ...
  return (
    <div>
      ...
      <TextField id="outlined-basic" size="small" label="Search..." variant="outlined" startIcon={<AddIcon />}/>
...
<div class="overflow-x-auto bg-white rounded-lg shadow p-4">
  <table class="w-full table-auto text-sm text-left">
    ...
    <tbody class="text-gray-900">
      <tr class="border-b hover:bg-gray-50">
        ...
        <td class="p-4">
          <span class="bg-green-100 text-green-800 text-xs font-semibold px-3 py-1 rounded-full">Paid</span>
        </td>
        <td class="p-4">
          <span class="bg-orange-100 text-orange-800 text-xs font-semibold px-3 py-1 rounded-full">Ready</span>
        </td>
  ...
  <div class="flex items-center justify-between mt-4 text-sm text-gray-500">
    <div class="flex gap-2 items-center">
      ...
      <button class="w-7 h-7 flex items-center justify-center rounded bg-gray-100 text-blue-600 font-semibold">1</button>
      <button class="w-7 h-7 flex items-center justify-center rounded hover:bg-gray-100">2</button>
      <button class="w-7 h-7 flex items-center justify-center rounded hover:bg-gray-100">3</button>
      <span class="px-2">...</span>
      <button class="w-7 h-7 flex items-center justify-center rounded hover:bg-gray-100">24</button>
